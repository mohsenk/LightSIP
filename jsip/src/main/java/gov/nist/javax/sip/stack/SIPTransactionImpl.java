...
public abstract class SIPTransactionImpl implements SIPTransaction {
	...
	/**
   * @see SIPTransaction#setOriginalRequest(gov.nist.javax.sip.message.SIPRequest)
   */
    @Override
...
//                originalRequestBytes = null;
    ...
    /**
     * @see SIPTransaction#setBranch(java.lang.String)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#sendMessage(gov.nist.javax.sip.message.SIPMessage)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#addEventListener(gov.nist.javax.sip.stack.SIPTransactionEventListener)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#removeEventListener(gov.nist.javax.sip.stack.SIPTransactionEventListener)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#setDialog(SIPDialog, java.lang.String)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#doesCancelMatchTransaction(gov.nist.javax.sip.message.SIPRequest)
     */
    @Override
...
//      TIMER_D = 32000 / BASE_TIMER_INTERVAL;
    ...
    /**
     * @see SIPTransaction#setApplicationData(java.lang.Object)
     */
    ...
    /**
     * @see SIPTransaction#isMessagePartOfTransaction(gov.nist.javax.sip.message.SIPMessage)
     */
    @Override
    ...
    /**
     * @see SIPTransaction#setForkId(java.lang.String)
     */
    @Override
